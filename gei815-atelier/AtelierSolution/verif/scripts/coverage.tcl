...
# explicitely don't consider analog models
deselect_coverage -all -instance tb_top.u_dut.u_channeltop0.u_ChannelAnalogTop...
deselect_coverage -all -instance tb_top.u_dut.u_channeltop1.u_ChannelAnalogTop...
